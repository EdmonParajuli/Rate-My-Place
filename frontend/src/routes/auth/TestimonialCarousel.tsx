...
// Ported from prototype/auth-screens Variant A.
const TESTIMONIALS = [
  {
    text: "Rate My Place helped me find the best plumber in town when I had an emergency.",
    author: "Sarah Jenkins, Local Guide",
    avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=150",
  },
  {
    text: "Claiming my listing changed everything — I can respond to customers directly.",
