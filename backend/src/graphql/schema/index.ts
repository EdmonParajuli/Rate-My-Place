...
import { authResolvers, placeResolver, sessionResolver, categoryResolver, reviewResolver, reviewReplyResolver, reviewVoteResolver, savedPlaceResolver, badgeResolver, notificationResolver, platformStatsResolver, businessDashboardResolver } from '../resolvers';
import { authTypedefs, placeDefs, sessionTypedefs, categoryTypedefs, reviewTypedefs, reviewReplyTypedefs, reviewVoteTypedefs, savedPlaceTypedefs, badgeTypedefs, notificationTypedefs, commonTypedefs, platformStatsTypedefs, businessDashboardTypedefs } from '../typeDefs';
